    ...
    <div className="my-20 lg:my-32 max-w-lg mx-auto font-medium">
      ...
      <div className="flex gap-2 justify-center mt-10">
        ...
        <Link
          ...
          <span className="inline-block h-6 lg:h-7 bg-left-bottom bg-gradient-to-r from-brown to-brown bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out cursor-pointer">
